    ...
    <script type="text/javascript">
        ...
        function goToPage(param){
            ...
            for (var i=0; i<=5; i++)
            {
                ...
                // var s_page = "page0.jsp?id=" + ( 10 + i ) + "&mth=" + current;
...
<table style="width: 100%; height: 95%;border: 0">
    ...
    <tr style="height: 50%;border:0">
        <td style="width: 33%;">
            <iframe src="page0.jsp?id=10" id="sub_frame0"></iframe>
        </td>
        <td style="width: 34%;">
            <iframe src="page0.jsp?id=11" id="sub_frame1"></iframe>
        </td>
        <td style="width: 33%;">
            <iframe src="page0.jsp?id=12" id="sub_frame2"></iframe>
        </td>
    </tr>
    ...
    <tr style="height: 50%;border:0">
        <td>
            <iframe src="page0.jsp?id=13" id="sub_frame3"></iframe>
        </td>
        <td>
            <iframe src="page0.jsp?id=14" id="sub_frame4"></iframe>
        </td>
        <td>
            <iframe src="page0.jsp?id=15" id="sub_frame5"></iframe>
        </td>
    </tr>
